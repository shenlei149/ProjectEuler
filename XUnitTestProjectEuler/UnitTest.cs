...
namespace XUnitTestProjectEuler
{
    ...
    public class UnitTest02
    {
        ...
        public void Test051To100()
        {
            ...
            Assert.Equal("1258", new S93().GetAnswer());
            ...
            Assert.Equal("18769", new S98().GetAnswer());
    ...
    public class UnitTest03
    {
        ...
        public void Test101To150()
        {
            ...
            Assert.Equal("259679", new S107().GetAnswer());
            Assert.Equal("180180", new S108().GetAnswer());
            Assert.Equal("38182", new S109().GetAnswer());
            Assert.Equal("9350130049860600", new S110().GetAnswer());
            Assert.Equal("1587000", new S112().GetAnswer());
            Assert.Equal("51161058134250", new S113().GetAnswer());
            Assert.Equal("16475640049", new S114().GetAnswer());
            Assert.Equal("168", new S115().GetAnswer());
            Assert.Equal("20492570929", new S116().GetAnswer());
            Assert.Equal("100808458960497", new S117().GetAnswer());
            Assert.Equal("44680", new S118().GetAnswer());
            Assert.Equal("248155780267521", new S119().GetAnswer());
            Assert.Equal("333082500", new S120().GetAnswer());
            Assert.Equal("2269", new S121().GetAnswer());
    ...
    public class UnitTest04
    {
        ...
        public void Test151To200()
        {
            ...
            Assert.Equal("209566", new S174().GetAnswer());
    ...
    public class UnitTest15
    {
        ...
        public void Test701To750()
        {
            ...
            Assert.Equal("94586478", new S745().GetAnswer());
        }
    }
    ...
    {
        [Fact]
        public void Test751To800()
        {
            Assert.Equal("2.223561019313554106173177", new S751().GetAnswer());
            Assert.Equal("75737353", new S757().GetAnswer());
            Assert.Equal("471745499", new S788().GetAnswer());
            Assert.Equal("1412403576", new S800().GetAnswer());
        }
    }
    ...
    public class UnitTest19
    {
        ...
        public void Test901To950()
        {
            ...
            Assert.Equal("0.2928967987", new S938().GetAnswer());
        }
    }
}
